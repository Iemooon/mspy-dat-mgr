...
![Application screenshot](screenshots/mspy-dat-mgr.png)

## Download and use

For regular Windows users, download the ZIP package from the repository's [Releases](https://github.com/Iemooon/mspy-dat-mgr/releases) page, extract the entire archive, and run `mspy-dat-mgr.exe`. Python installation is not required.
